...
function Contribution(){
    return(<div class = "content">
      ...
      <p>Finding a project you're interested in seems like an easy task; you just find an interesting project and contribute, right?
        ...
        Is there a specific project you're really passionate about? Is there a project you want to be part of?</p>
  ...
  Once you choose an issue you want to work on, ask the maintainer to get assigned through the comments!
    ...
    <h1>
    5. Fork, clone, & run the project locally🍴
    </h1>
    <p>
